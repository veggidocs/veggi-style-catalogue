      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-20 md:pb-32">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="max-w-xl animate-fade-up">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-medium text-white leading-[0.9] tracking-tight mb-8">
              Sleepwear
              <br />
              <span className="text-white/60">B2B</span>
            </h1>
            
            <p className="text-lg md:text-xl text-white/70 font-light mb-10 max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#cliente"
                className="inline-flex items-center justify-center px-8 py-4 border border-white/40 text-white text-sm font-medium tracking-wide uppercase transition-all duration-300 hover:bg-white/10"
              >
                Já sou cliente
              </a>
            </div>
